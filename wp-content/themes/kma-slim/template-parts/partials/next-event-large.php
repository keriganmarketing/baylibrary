    ...
    <div class="columns is-multiline is-aligned is-justified is-gapless">
        ...
        <div class="column event-details is-6-desktop">
            <div class="detail-container">
                ...
                <h3 class="subtitle is-5"><?= $nextEvent['name']; ?></h3>
                <table>
                    <tr><td class="label">TIME:</td><td class="data"><?= $nextEvent['time']; ?></td></tr>
                    <tr><td class="label">DATE:</td><td class="data"><?= date('l, F jS', $date); ?></td></tr>
                    <tr><td class="label">LOCATION:</td><td class="data"><?= nl2br($nextEvent['location']); ?></td></tr>
                </table>
