...
<head>
    ...
    <style>
        * { font-family: sans-serif; }
        h2 { color: #f7941d; font-weight:bold; }
...
<table
    ...
    <tbody>
    <tr>
        <td style="padding:20px; border:1px solid #ddd; border-top:10px solid #f7941d; border-bottom: 0;" >
            <h2>{headline}</h2>
            <p>{introcopy}</p>
    ...
    <tr>
        <td style="border-bottom: #0197b7 solid 2px; border-left:1px solid #ddd; border-right:1px solid #ddd; padding:10px;">
